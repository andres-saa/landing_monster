<template>
    ...
    <div class="col-12  my-8 md:my-8 p-0" v-if="store.cart.products.length > 0">
        <P class="text-center text-6xl my-8 text-white"><b>CARRITO DE COMPRAS</b> </P>
        ...
        <div class="grid mx-auto " style="max-width:800px;">
            ...
            <div class="col-12 text-sm md:col-6 p-3 md:px-4" style="display: flex; flex-direction: column; gap:1rem;justify-content: center;">
                ...
                <div class=" col-12 py-3 p-shadow "
                    style=" display: flex;align-items:end;position: relative;background-color: white; gap:1rem;border-radius: 0.3rem;"
                    ...
                    <Button class="ml-2" @click="store.removeProductFromCart(product.product.id) " icon="pi pi-trash"
                        ...
                        style="border:none;right: -.5rem;top: -.5rem;background-color: black; position: absolute; outline:none;width:2rem; height:2rem" />
                ...
                <div class="col-12 p-0 mt-1">
                    <div class="p-shadow p-3 mb-4 " v-for="(items, grupo) in agrupados" :key="grupo" style="position: relative;background-color: white; border-radius: 0.3rem;">
                            ...
                            <div class="mt-2">
                                <div v-for="item in items" :key="item.aditional_item_instance_id"
                                    ...
                                    <Button text rounded @click="deleteAd(item)" class="p-0 m-0" severity="danger"
                                        style="width: 2rem;  height: 2rem;border: none;background-color: ;" icon="pi pi-trash m-0"></Button>
                    ...
                    <div  @click="store.setVisible('addAdditionToCart',true)" class="col-12 p-0 m-0" style="display: flex; justify-content: end;">
                        <Button style="width: 2rem;left: .3rem; height: 2rem;background-color: black;" rounded severity="danger" icon="pi pi-plus"></Button>
